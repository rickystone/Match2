...
bool physic::init()
{
    ...
    auto closeItem = MenuItemImage::create(
                                           "CloseNormal.png",
                                           "CloseSelected.png",
                                           CC_CALLBACK_1(physic::menuCloseCallback, this));
    ...
    touchListener->onTouchBegan = CC_CALLBACK_2(physic::onTouchBegan, this);
    touchListener->onTouchEnded = CC_CALLBACK_2(physic::onTouchEnded, this);
    _eventDispatcher->addEventListenerWithSceneGraphPriority(touchListener, this);
    
    // 碰撞检测回调
    auto contactListener = EventListenerPhysicsContact::create();
    contactListener->onContactBegin = CC_CALLBACK_2(physic::onContactBegin, this);
    _eventDispatcher->addEventListenerWithSceneGraphPriority(contactListener, this);
    return true;
}


bool physic::onContactBegin(EventCustom *event, const PhysicsContact& contact)
{
...
bool physic::onTouchBegan(Touch *touch, Event *unused_event)
{
    return true;
}

void physic::onTouchEnded(Touch *touch, Event *unused_event)
{
...
void physic::addNewSpriteAtPosition(Point p)
{
...
void physic::menuCloseCallback(Object* pSender)
{
